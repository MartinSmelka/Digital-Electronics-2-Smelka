 ...
 */
/** @brief Stop timer, prescaler 000 --> STOP */
#define TIM0_stop()           TCCR2B &= ~((1<<CS02) | (1<<CS01) | (1<<CS00));
/** @brief Set overflow 16us, prescaler 001 --> 1 */
#define TIM0_overflow_16us()   TCCR2B &= ~((1<<CS02) | (1<<CS01)); TCCR2B |= (1<<CS00);
/** @brief Set overflow 128us, prescaler 010 --> 8 */
#define TIM0_overflow_128us()  TCCR2B &= ~((1<<CS02) | (1<<CS00)); TCCR2B |= (1<<CS01);
/** @brief Set overflow 512ms, prescaler 011 --> 64 */
#define TIM0_overflow_512ms() TCCR2B &= ~(1<<CS02); TCCR2B |= (1<<CS01) | (1<<CS00);
/** @brief Set overflow 1ms, prescaler 011 --> 64 */
#define TIM0_overflow_1ms() TCCR2B &= ~(1<<CS02); TCCR2B |= (1<<CS01) | (1<<CS00);
/** @brief Set overflow 2ms, prescaler 100 --> 256 */
#define TIM0_overflow_2ms()    TCCR2B &= ~((1<<CS01) | (1<<CS00)); TCCR2B |= (1<<CS02);
/** @brief Set overflow 4ms, prescaler 100 --> 256 */
#define TIM0_overflow_4ms()    TCCR2B &= ~((1<<CS01) | (1<<CS00)); TCCR2B |= (1<<CS02);
/** @brief Set overflow 16ms, prescaler // 101 --> 1024 */
#define TIM0_overflow_16ms()    TCCR2B &= ~(1<<CS01); TCCR2B |= (1<<CS02) | (1<<CS00);
